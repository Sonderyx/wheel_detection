...
public class SettingsMain extends Settings {
	...
	private abstract class SettingResolution extends SettingRadio {//picres_640
		SettingResolution(String name, int res) {
			super(name, res, 8, new int[] {
					R.string.picres_320,
					R.string.picres_384,
					R.string.picres_640,
					R.string.picres_768,
					...
					R.string.picres_288w,
					R.string.picres_576w,
	...
	private final Setting[] settings = {
		...
		new SettingSliderInt("shutinterval", R.string.set_shutinterval, 60, 0, 1000, 10) {
			@Override
			void onSet(int i) {
				if (i == 0)
		...
		new SettingRadio("imode", R.string.set_imode, 0, new int[] {
